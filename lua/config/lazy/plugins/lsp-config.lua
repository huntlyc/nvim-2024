...
local lsp_keymaps = function(bufnr)
    ...
    keymap("n", "<leader>tr", run_current_or_corresponding_test, vim.tbl_extend("force", opts, { desc = "Run test" }))
    keymap("n", "<leader>gtt", go_to_test, vim.tbl_extend("force", opts, { desc = "Go to test file" }))
    keymap("n", "<leader>gg", vim.diagnostic.open_float, vim.tbl_extend("force", opts, { desc = "Diagnostic float" }))
    keymap("n", "<leader>gd", vim.lsp.buf.definition, vim.tbl_extend("force", opts, { desc = "Go to definition" }))
    keymap("n", "<leader>gt", vim.lsp.buf.type_definition, vim.tbl_extend("force", opts, { desc = "Go to type definition" }))
    keymap("n", "<leader>gi", vim.lsp.buf.implementation, vim.tbl_extend("force", opts, { desc = "Go to implementation" }))
    keymap("n", "<leader>gr", vim.lsp.buf.rename, vim.tbl_extend("force", opts, { desc = "Rename symbol" }))
    ...
    keymap("n", "<leader>gtr", "<cmd>Telescope lsp_references<CR>", vim.tbl_extend("force", opts, { desc = "References" }))
    keymap("n", "<leader>gl", "<cmd>Telescope diagnostics<CR>", vim.tbl_extend("force", opts, { desc = "Line diagnostics" }))
